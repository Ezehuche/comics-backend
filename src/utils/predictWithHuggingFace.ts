...
import { createZephyrPrompt } from './createZephyrPrompt';
...
export async function predict({
  ...
  switch (llmEngine) {
    ...
    default:
      const error =
        'Please check your Hugging Face Inference API or Inference Endpoint settings';
      console.error(error);
      throw new Error(error);
  }
